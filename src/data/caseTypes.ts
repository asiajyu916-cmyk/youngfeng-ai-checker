...
export const CASE_TYPES: CaseTypeConfig[] = [
  ...
  // ── 4. 廠房 ────────────────────────────────────────────────
  {
    ...
    label: '廠房',
    icon: '🏭',
    description: '工廠、倉庫、廠辦複合',
    defaultBuildingUse: '工廠',
    buildingUseOptions: ['工廠', '倉儲', '辦公'],
    baseModules: [
      { code: 'MOD_01', name: '土管',       reason: '工業區土管必辦' },
      { code: 'MOD_06', name: '建技規',     reason: '每案必辦' },
      { code: 'MOD_11', name: '停車空間',   reason: '每案必辦' },
      { code: 'MOD_13', name: '消防',       reason: '每案必辦' },
      { code: 'MOD_15', name: '防火避難',   reason: '廠房必辦：防火區劃、避難設計' },
    ],
    conditionalHints: [
      { code: 'MOD_02', name: '都審',     reason: '面積達都審門檻' },
      { code: 'MOD_07', name: '綠建築',   reason: '公有≥500㎡' },
      { code: 'MOD_04', name: '高層',     reason: '≥16F 或 >50m（廠房較少見）' },
    ],
  },
  ...
  // ── 5. 其他 ────────────────────────────────────────────────
  {
    ...
    label: '其他',
    icon: '🏗️',
    description: '旅館、醫療、學校、宗教等特殊用途',
    defaultBuildingUse: '',
    buildingUseOptions: ['旅館', '醫療', '學校', '政府機關', '宗教', '其他'],
    baseModules: [
      { code: 'MOD_01', name: '土管',       reason: '每案必辦' },
      { code: 'MOD_06', name: '建技規',     reason: '每案必辦' },
      { code: 'MOD_11', name: '停車空間',   reason: '每案必辦' },
      { code: 'MOD_12', name: '無障礙',     reason: '公眾使用建築物' },
      { code: 'MOD_13', name: '消防',       reason: '每案必辦' },
      { code: 'MOD_15', name: '防火避難',   reason: '特殊用途必辦' },
    ],
    conditionalHints: [
      { code: 'MOD_02', name: '都審',       reason: '面積達都審門檻' },
      { code: 'MOD_04', name: '高層',       reason: '≥16F 或 >50m' },
